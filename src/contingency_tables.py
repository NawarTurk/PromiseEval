...
def generate_contingency_tables():
    ...
    task1_json_path = os.path.join(processed_data_path, 'task1.json')
    task2_json_path = os.path.join(processed_data_path, 'task2.json')
    ...
    task1_contingencyTable_path = os.path.join(results_path, 'task1_contingency_table.csv')
    ...
    task2_contingencyTable_path = os.path.join(results_path, 'task2_contingency_table.csv')
